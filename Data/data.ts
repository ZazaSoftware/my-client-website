export const BaseInfo = {
  name: "chukwunonso",
  position: "a Graphics Designer ",
  description:"The truth is that the pain itself will be followed by the adipiscing elitist. He wants to never go on, but he will open the door even if the pleasures are born to forgive him? Who is easy with the hate itself!",
  profilePic: "/images/herooo.png",
};

export const aboutInfo = {
  title: "Crafting Graphics Design with Passion and Precision",
  description:
    "At Army Arts, we’re a dedicated team of designers and developers committed to delivering tailored Graphics Design solutions. With a blend of creativity and technical expertise, we help businesses elevate their online presence and achieve their goals",
  client: "100+",
  experience: "7+",
  project: "200+",
  website: "100+",
...
export const servicesData = [
  ...
  {
    id: 5,
    title: "Ghapics Database Solutions",
    description:
...
export const contactData = {
  phone: "+2349028823818",
  email: "ajaguprinceart@gmail.com",
  whatsapp: "+2349028823818",
  address: "20, Alhaji Tella strt, Egbeda Akowonjo lagos , nigeria",
};